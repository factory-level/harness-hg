...
import { CliError, HG_HOME, log, ok, sh, STAGING, type HgState } from "../lib.ts";

export const REGISTRY_CONTAINER = "hg-oci-registry";
const K3D_NETWORK = "k3d-hermes-gitops-cli";
