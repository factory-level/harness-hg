...
| **Harness** | The runtime that boots an agent and talks to the platform. Each harness ships a harness declaration. Types: **Eve** (default), **Hermes Agent** (coming soon). [Harness](platform/runtime.md) |
